<div class="container mt-5">
    ...
    <form action="<?php echo base_url('Avisos_c/crear') ?>" method="post">
        <div class="modal fade" id="modalCrearAviso" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body mx-3">
                        ...
                        <div class="md-form mb-5 amber-textarea active-amber-textarea-2">
                            ...
                            <textarea id="cuerpo_an" name="cuerpo_an" class="md-textarea form-control" rows="3" required></textarea>
