        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-header row">
                    <div class="media">
                        <div>
                            ...
                            <?php else : ?>
                                <img id="avatar" src="<?php echo base_url($perfil[0]['img_usu']) ?>" class="rounded-circle z-depth-0" alt="avatar image">
                            <?php endif; ?>
                ...
                <?php if ($_SESSION["id_login"] != $perfil[0]['id_usu']) : ?>
                    <button class="btn btn-secondary" data-toggle="modal" data-target="#modalMensaje" id="formMensaje" type="button"><span>
                            <i class="fas fa-paper-plane"></i>
                        </span>Enviar un mensaje</button>
                <?php endif; ?>
                <?php if ($_SESSION["id_login"] == $perfil[0]['id_usu']) : ?>
                    <button class="btn btn-primary" id="modalActivate" type="button" data-toggle="modal" data-target="#modalPerfil" type="button"><span>
                            <i class="fas fa-cogs"></i>
                        </span>Modificar perfil</button>
                    <button class="btn btn-default" id="modal" type="button" data-toggle="modal" data-target="#modalIMG" type="button"><span>
                ...
                <form method="post" id=formCambio action="<?php echo base_url('usuarios_c/enviarCambios/') ?>">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input value="<?php echo $perfil[0]['email_usu'] ?>" id="email_usu" placeholder="E-Mail" name="email_usu" pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="form-control" type="email" placeholder="usuario@dominio.com" required>
                        </div>
                    </div>
                    ...
                    <?php if ($perfil[0]['tipo_usu'] == "m") : ?>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="musico" name="tipo_usu" value="m" checked class="custom-control-input" required>
                    ...
                    <?php elseif ($perfil[0]['tipo_usu'] == "g") : ?>
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="grupo" name="tipo_usu" value="g" checked class="custom-control-input" required>
                            <label class="custom-control-label" for="grupo">Grupo</label>
                        </div>
                    <?php endif; ?>
                    <hr>
                    <div class="form-group">
                        ...
                        <input id="apenom_usu" value="<?php echo $perfil[0]['apenom_usu']; ?>" name="apenom_usu" class="form-control" type="text" maxlength="125" placeholder="Nombre y apellidos" required>
                    </div>
                    <div class="form-group">
                        <label for="ciudad_usu">Ciudad</label>
                        <input id="ciudad_usu" value="<?php echo $perfil[0]['ciudad_usu']; ?>" name="ciudad_usu" placeholder="Ciudad" maxlength="15" class="form-control" type="text" required>
                    </div>
                    <div class="form-group">
                        <label for="estilo_usu">Estilo músical</label>
                        <input id="estilo_usu" value="<?php echo $perfil[0]['estilo_usu']; ?>" name="estilo_usu" placeholder="Estilo músical" maxlength="25" class="form-control" type="text">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="md-form amber-textarea active-amber-textarea-2">
                        ...
                        <textarea type="text" id="desc_usu" name="desc_usu" class="md-textarea form-control" rows="5"><?php echo $perfil[0]['desc_usu'] ?></textarea>
                    </div>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalIMG" aria-labelledby="modalIMG" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    <form method="post" action="<?php echo base_url('usuarios_c/setImagen/') ?>" enctype="multipart/form-data">
                        <div class="input-group">
                            <div class="input-group-prepend">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="img_usu" name="img_usu" aria-describedby="inputGroupFileAddon01">
