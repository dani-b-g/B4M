...
<body class="">
    <nav class="mb-1 navbar navbar-expand-lg sticky-top navbar-dark purple darken-4 lighten-1">
        <a class="navbar-brand" href="<?php echo base_url(); ?>"><img id=logo src="<?php echo (base_url('/assets/img/logo.png')); ?>" alt=""></a>
            ...
            <?php if (isset($_SESSION['login']) && $_SESSION['login'] == true) : ?>
                <ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-555" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Mensajes
                            </a>
                            <div class="dropdown-menu dropdown-secondary" aria-labelledby="navbarDropdownMenuLink-555">
                                <a class="dropdown-item" href="<?php echo base_url('mensajes_c/mensajes') ?>">Recibidos</a>
                                <a class="dropdown-item" href="<?php echo base_url('mensajes_c/enviados') ?>">Enviados</a>
                            </div>
                        </li>
                ...
                <form class="form-inline" method="post" action="<?php echo base_url('buscador_c/') ?>">
                    <div class="input-group md-form form-sm form-1 pl-0">
                        ...
                        <input class="form-control my-0 py-1" type="text" id="busqueda" name='busqueda' placeholder="Buscar usuarios">
                    </div>
                </form>
            </div>
            <ul class="navbar-nav ml-auto nav-flex-icons">
                ...
                <li class="nav-item avatar dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-55" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <?php else : ?>
                            <img id="avatar" src="<?php echo base_url($_SESSION['img_usu']) ?>" class="rounded-circle z-depth-0" alt="avatar image">
                        <?php endif; ?>
                    </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-secondary" aria-labelledby="navbarDropdownMenuLink-55">
                        <a class="dropdown-item" href="<?php echo base_url("/usuarios_c/perfil/{$_SESSION['usuario']}") ?>">Perfil</a>
