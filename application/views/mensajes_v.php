        ...
        <div class="card-body">
            ...
            <div class="card-text">
                <ul class="list-group">
                    ...
                    <li data-mensaje-type='<?php echo $value->id_men ?>' data-des-type='<?php echo $value->des_men ?>' id='<?php echo $value->rem_men ?>' class="list-group-item d-flex btn purple-gradient justify-content-between align-items-center mensajes">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="<?php echo base_url('/mensajes_c/enviarmen/') ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input id="titulo_men" maxlength="50" name="titulo_men" class="form-control" type="text" required>
                    </div>
                    <div class="form-group">
                        <div class="md-form amber-textarea active-amber-textarea-2">
                            <label class="" for="cuerpo_men">Cuerpo Mensaje</label>
                            <textarea type="text" id="cuerpo_men" name="cuerpo_men" class="md-textarea form-control" rows="5" required></textarea>
                        </div>
                    </div>
            </div>
